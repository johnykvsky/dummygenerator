...
class Country implements CountryExtensionInterface, RandomizerAwareExtensionInterface
{
    ...
    {
        return $this->randomizer->randomElement($this->alpha2);
    }

    public function countryISOAlpha3(): string
    {
        return $this->randomizer->randomElement($this->alpha3);
    }
}
