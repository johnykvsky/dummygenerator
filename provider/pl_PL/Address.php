...
class Address extends BaseAddress
{
    ...
    protected array $buildingNumber = ['##A', '%#', '##A/%#', '%#/%#'];
    protected array $postcode = ['##-###'];
    /**
     * @var array<string> full list of Polish voivodeship
     */
    ...
    /**
     * @var array<string> Countries in Polish
     *
    ...
    /**
     * @var array<string> 250 Polish cities with biggest number of streets. Extracted from data issued by the official
    ...
    /**
     * @var array<string> 549 most common Polish street names. Extracted from data issued by the official public
